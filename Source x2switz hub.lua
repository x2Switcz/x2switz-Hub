...
if IKAI then
	...
	function library:Window(text,text2,text3,logo,keybind)
		...
		Top.Name = "Top"
		Top.Parent = Main
		Top.BackgroundColor3 = Color3.fromRGB(160, 32, 240)
		...
		Hub.Name = "Hub"
		Hub.Parent = Top
		Hub.BackgroundColor3 = Color3.fromRGB(160, 32, 240)
		...
		BindButton.TextColor3 = Color3.fromRGB(255, 0, 0)
...
function CheckStatus()
	...
	Kill_Cake_Monster_ST:Set("Kill Cake Monster : "..tostring(Lp).."500/500")
	if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TalkTrevor","1") == 0 then
