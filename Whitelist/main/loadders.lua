...
getgenv()['Check_Setting'] = function(Name)
    if not _G.Dis and not isfolder('x2switz Hub BF Premium') then
        makefolder('x2switz Hub BF Premium')
    end
    if not _G.Dis and not isfile('x2switz Hub BF Premium/'..Name..'.json') then
        writefile('x2switz Hub BF Premium/'..Name..'.json',JsonEncode(_G.Setting_table))
    end
end
getgenv()['Get_Setting'] = function(Name)
    if not _G.Dis and isfolder('x2switz Hub BF Premium') and isfile('x2switz Hub BF Premium/'..Name..'.json') then
        _G.Setting_table = JsonDecode(readfile('x2switz Hub BF Premium/'..Name..'.json'))
...
Quest_Tab:Toggle("Auto Phoenix Awaken (Bug)","9606294253",_G.Setting_table.Auto_Phoenix_Awaken,function(vu)
...
PvP_Tab:Toggle("Auto Farm Bounty (Bug)","9606294253",_G.Setting_table.Auto_Farm_Bounty,function(vu)
	Auto_Farm_Bounty = vu
...
elseif Three_World  then
    Island_Tab:Button("port Town", function()
        TP2(CFrame.new(-339.97287, 28.7907715, 5383.02832))
    end)

    Island_Tab:Button("Haydar Island", function()
        TP2(CFrame.new(5294.52637, 602.030457, 362.93338))
    end)
    
    Island_Tab:Button("Green Tree", function()
        TP2(CFrame.new(2271.48462, 25.2306652, -6406.27002))
    end)
    
    Island_Tab:Button("NPC Green Tree", function()
    ...
    Island_Tab:Button("Mansion", function()
        TP2(CFrame.new(-12550.5654, 337.194061, -7490.75098))
    end)

    Island_Tab:Button("Sea island", function()
        TP2(CFrame.new(-5050.30078, 313.893555, -2994.84033))
    end)
    
    Island_Tab:Button("Bone island",function()
        TP2(CFrame.new(-9516.2373, 142.130615, 5549.93262))
    end)
    
    Island_Tab:Button("Room Raid", function()
    ...
    Island_Tab:Button("Soa of Cake island",function()
