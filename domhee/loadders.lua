...
local win = library:Window("x2switz",[[Hub]],[[Version : Premium ]],"9606070311",Enum.KeyCode.RightControl)
...
General_Tab:Toggle("Auto Farm","9606294253",_G.Setting_table.AutoFarm,function(vu)
    ...
    function AttackNoCD()
        ...
        if Auto_Farm_Bounty or Auto_Farm_Fruit and not Mix_Farm then
            ...
            Lop.activeController.hitboxMagnitude = 100
        end
    end
spawn(function()
	while wait(.1) do
